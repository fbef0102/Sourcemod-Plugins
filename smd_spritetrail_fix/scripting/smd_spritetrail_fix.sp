...
{
	name = "[Any] Spritetrail fix",
	author = "FrozDark",
	description = "Fixes env_spritetrail disappearing after a second when it was created.",
	version = "1.0",
	url = "https://forums.alliedmods.net/showthread.php?t=295728"
};
