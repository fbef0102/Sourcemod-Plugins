...
public void OnSocketConnected(Handle hSock, DataPack hPack)
{
	char steamID[18];
	char requestStr[256];
...
public void OnSocketReceive(Handle hSock, const char[] receiveData, const int dataSize, DataPack hPack)
{
	hPack.Reset();
	hPack.ReadCell();
...
public void OnSocketDisconnected(Handle hSock, DataPack hPack)
{
	hPack.Reset();
...
public void OnSocketError(Handle hSock, const int errorType, const int errorNum, DataPack hPack)
{
